    ...
    <div className="bg-[#050607] text-[#64748b] font-mono flex flex-col overflow-x-hidden relative scroll-smooth selection:bg-[#7be1ea] selection:text-black">
      ...
      <header className="h-24 flex items-center justify-between px-10 relative z-50 bg-[#050607]/80 backdrop-blur-md sticky top-0 border-b border-white/5">
        ...
        <nav className="flex items-center gap-8 text-[11px] font-bold tracking-widest uppercase">
          <a href="#about" className="hover:text-[#7be1ea] transition-colors border-b border-transparent hover:border-[#7be1ea] pb-1">ABOUT US</a>
          ...
          <div className="flex items-center gap-2 border border-white/20 px-3 py-1.5 rounded-sm hover:bg-white/5 cursor-pointer transition-colors text-white">
            <span>EN</span>
            <ChevronDown size={14} />
          </div>
        </nav>
      ...
      <main className="min-h-[calc(100vh-6rem)] flex items-center justify-center px-10 relative z-10 max-w-[1600px] mx-auto w-full gap-10 py-20 lg:py-0">
        ...
        <div className="flex-1 flex flex-col justify-center pl-12 gap-8 relative z-20">
           <div className="flex flex-col">
              <h1 className="text-white font-black text-[5.5rem] font-sans tracking-tighter leading-[1] mb-4 drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]">
              ...
              <h2 className="text-[#7be1ea] font-black text-6xl font-sans tracking-tight leading-[1] drop-shadow-[0_0_15px_rgba(123,225,234,0.3)]">
                 PREDICTING <br /> 
                 <span className="text-[#a3e635] drop-shadow-[0_0_15px_rgba(163,230,53,0.3)] block mt-3">THE ANOMALY.</span>
              </h2>
           </div>

           <p className="text-[#64748b] text-sm tracking-widest max-w-xl leading-relaxed mt-4 border-l-[3px] border-[#c084fc] pl-6 py-2">
              Next-generation spatial awareness and telemetry tracking infrastructure. Authorize your terminal to synchronize with the orbital grid.
           </p>
           ...
           <div className="flex items-center gap-6 mt-8">
              ...
              <Link href="/auth/register" className="border border-white/20 text-white hover:border-[#a3e635] hover:text-[#a3e635] font-bold text-xs tracking-[0.2em] px-10 py-5 rounded-sm transition-all hover:-translate-y-1">
                 REGISTER TERMINAL
              </Link>
           </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row gap-20 items-center">
               ...
               <div className="flex-1 flex flex-col gap-8">
                  <div className="flex items-center gap-4 text-[#a3e635] text-sm font-bold tracking-[0.3em] mb-2 uppercase">
                     <Crosshair size={18} /> PROJECT VISION
                  </div>
                  <h3 className="text-white font-sans font-black text-5xl tracking-tight leading-[1.1]">
                     DECODE THE INVISIBLE <span className="text-[#7be1ea] block mt-2 drop-shadow-[0_0_10px_rgba(123,225,234,0.3)]">THREATS.</span>
                  </h3>
                  <div className="text-[#64748b] leading-relaxed text-[13px] tracking-widest flex flex-col gap-6 mt-4 border-l border-[#1e293b] pl-8">
                     <p>
                        Orbital Sense was developed at the core of modern telemetry and space infrastructure challenges for the TUA Hackathon. In an era where extreme Solar Flares, atmospheric anomalies, and transformer collapses threaten critical hardware, our mission is to build a massive and "Smart" prediction matrix.
                     </p>
                     <p>
                        By simultaneously processing in-orbit Satellites, transcontinental Cargo Planes, high-voltage Transformers, and global Datacenters through the <span className="text-white font-bold">Aurora AI</span> network, we provide a simulation capable of isolating environmental & solar fluctuations before they inevitably impact critical assets.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex-1 grid grid-cols-2 gap-6 w-full">
                  <div className="bg-[#050607] border border-white/5 p-10 flex flex-col gap-4 rounded-sm hover:-translate-y-2 transition-transform shadow-[0_10px_30px_rgba(0,0,0,0.5)] group relative overflow-hidden">
                     ...
                     <h4 className="text-white font-bold text-xl tracking-widest mt-2">REAL-TIME SYNC</h4>
                     <p className="text-[#475569] text-xs tracking-widest leading-relaxed">Sub-second synchronization spanning a global map matrix for 4 distinct asset classes: Planes, Satellites, Transformers, and Datacenters.</p>
                  </div>
                  <div className="bg-[#050607] border border-white/5 p-10 flex flex-col gap-4 rounded-sm hover:-translate-y-2 transition-transform shadow-[0_10px_30px_rgba(0,0,0,0.5)] group relative overflow-hidden">
                     ...
                     <h4 className="text-white font-bold text-xl tracking-widest mt-2">AURORA AI</h4>
                     <p className="text-[#475569] text-xs tracking-widest leading-relaxed">Kritik Güneş patlamalarını (Solar etkinlikleri) ölçen, otonom altyapı koruyucusu uyarı matrisi.</p>
                  </div>
                  <div className="bg-[#050607] border border-white/5 p-10 flex flex-col gap-4 rounded-sm hover:-translate-y-2 transition-transform shadow-[0_10px_30px_rgba(0,0,0,0.5)] group relative overflow-hidden">
                     ...
                     <h4 className="text-white font-bold text-xl tracking-widest mt-2">GLOBAL SCALE</h4>
                     <p className="text-[#475569] text-xs tracking-widest leading-relaxed">Differentiated authorization roles tailored for Observers and Operators. Massive scope ranging from System Logs telemetry analysis to Pro Request governance.</p>
                  </div>
                  <div className="bg-[#050607] border border-white/5 p-10 flex flex-col gap-4 rounded-sm hover:-translate-y-2 transition-transform shadow-[0_10px_30px_rgba(0,0,0,0.5)] group relative overflow-hidden">
                     ...
                     <h4 className="text-white font-bold text-xl tracking-widest mt-2">SECURE PROTOCOL</h4>
                     <p className="text-[#475569] text-xs tracking-widest leading-relaxed">Strictly compatible with robust FastAPI integrations, utilizing a secure Mock-Free infrastructure architecture bound to an aesthetic UI Matrix.</p>
                  </div>
               </div>
      ...
      <style jsx global>{`
        ...
        /* Ensure smooth scrolling when clicking anchors */
        html {
