                   ...
                   {assetTypes.map((type) => {
                     ...
                     return (
                       <div 
                         ...
                         className={`relative h-[160px] border cursor-pointer overflow-hidden rounded-sm transition-all duration-300 group ${
                           isSelected ? `${type.border} ${type.glow}` : "border-white/5 bg-[#15171b] hover:border-white/20"
                         }`}
                       >
                         {/* Background Image */}
                         <div className="absolute inset-0 z-0">
                           <img 
                             ...
                             className={`w-full h-full object-cover transition-all duration-700 ${
                               isSelected ? "opacity-60 scale-105 contrast-125 saturate-150" : "opacity-20 grayscale scale-100 group-hover:opacity-40 group-hover:grayscale-[50%]"
                             }`} 
                           />
                         </div>
                         {/* Gradient Overlay */}
                         <div className={`absolute inset-0 bg-gradient-to-t ${
                           isSelected ? 'from-[#050607]/90 via-[#050607]/30' : 'from-[#050607]/90 via-[#050607]/60'
