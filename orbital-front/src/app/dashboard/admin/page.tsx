        ...
        <aside className="w-[280px] bg-[#0c0d0f] border-r border-[#1e293b] flex flex-col py-8 shrink-0 shadow-[10px_0_30px_rgba(0,0,0,0.5)] z-20">
           <div className="px-6 mb-8 flex items-center gap-4">
              ...
              <div className="flex flex-col">
                 <span className="text-[#7be1ea] font-bold text-xs tracking-widest">{data.adminName}</span>
                 <span className="text-[#a3e635] text-[9px] tracking-[0.1em] font-bold">{data.adminLocation}</span>
              </div>
           </div>

           <div className="px-6 mb-8 w-full">
              <button className="w-full bg-[#7be1ea] text-black font-extrabold text-[10px] tracking-[0.2em] py-4 rounded-sm hover:-translate-y-0.5 hover:shadow-[0_5px_15px_rgba(123,225,234,0.3)] transition-all">
                 GENERATE REPORT
              </button>
           </div>
